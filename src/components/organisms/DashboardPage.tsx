...
const DashboardPage = () => {
  // Array yang berisi data untuk setiap kartu menu di dashboard
  const quickLinks = [
    {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Bagian 2: Statistik Antrian */}
      <div>
        <h2 className="text-xl font-semibold text-gray-900 mb-4">
          Statistik Antrian Hari Ini
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* ... (kode 4 kartu statistik dari langkah sebelumnya) ... */}
          ...
          <Card className="bg-green-50 border-green-200">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-3xl font-bold text-green-900 mt-1">4</h3>
              </div>
      ...
      {/* Bagian 3: Akses Cepat (Baru ditambahkan) */}
      <div>
        <h2 className="text-xl font-semibold text-gray-900 mb-4">
          Akses Cepat
        </h2>
